...
import EO from '../assets/images/envelope-outline.svg'
const Footer = () => {
  return (
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="subscription-form">
                            <h3 class="d-flex align-items-center"><span class="me-1"><img src={EO} alt="Image" class="img-fluid"/></span><span>Subscribe to Newsletter</span></h3>
